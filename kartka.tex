...
$$cond(x) = \left| \frac{xf'(x)}{x} \right| \qquad \sum_{k=1}^{n} \left| \frac{x_k \frac{\partial f}{\partial x_k}(x_1,\ldots,x_k)}{f(x_1,\ldots,x_k)} \right| ||\delta_k| (f:\mathbb{R}^k \rightarrow \mathbb{R})$$
